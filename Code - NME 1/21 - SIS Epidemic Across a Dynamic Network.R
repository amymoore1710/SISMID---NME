...
# concurrent - counts number of nodes with at least 2 edges (degree 2+)
# degrange - hard-codes that no nodes have degree higher than 4 (implied from 4 to inf)



  #List of target stats (# edges, # concurrent, # nodes degree 4+)
...
#plot smoothed summary prevalence instead of count on y-axis
